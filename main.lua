...
local theGround2 = display.newImage( "/assets/land.png" )
...
local landSquare = display.newImage( "/assets/landSquare.png" )
...
local theCharacter = display.newImageRect( "/assets/character.png", 75, 50 )
...
local dPad = display.newImage( "/assets/d-pad.png" )
...
local shootButton = display.newImageRect( "/assets/jumpButton.png", 75, 75 )
...
function jumpButton:touch( event )
    ...
    if ( event.phase == "ended" ) then
        ...
        theCharacter:setLinearVelocity( 0, -300 )
...
function shootButton:touch( event )
    ...
    if ( event.phase == "began" ) then
        ...
        local aSingleBullet = display.newImageRect( "/assets/bullet.jpg", 50, 15 )
